...
namespace Com.Natoma.HhsPrototype.UserInterface
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/js/location").Include(
                        "~/Scripts/js/location.js"));

            bundles.Add(new ScriptBundle("~/bundles/js/message").Include(
                        "~/Scripts/js/message.js"));

            bundles.Add(new ScriptBundle("~/bundles/js/userprofile").Include(
